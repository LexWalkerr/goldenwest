      ...
      <div style="width: full; display: flex; justify-content: center;">
        ...
        >
          ...
          <path
            ...
            fill="#7FBA00"
          ></path>
          <path d="M0.5 0.5H11.7617V11.7617H0.5V0.5Z" fill="#F25022"></path>
        </svg>
      </div>
...
.page {
  ...
  background: url("https://logincdn.msftauth.net/shared/5/js/../images/fluent_web_dark_2_bf5f23287bc9f60c9be2.svg");

  /* radial-gradient(circle at top,#2d3556,#0b1020 70%); */
}
